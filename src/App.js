...
class App extends Component {
  ...
  deleteTrack = id => {
    this.setState(prevState => ({
      trackList: prevState.trackList.filter(track => track.id !== id),
    }))
  }

  render() {
    const {trackList, searchInput} = this.state
    const searchedList = trackList.filter(track =>
      ...
      <AppContainer>
        ...
        <TrackContainer>
          <HeadingContainer>
            ...
            <SearchContainer>
              <SearchInput type="search" onChange={this.search} />
              <SearchIcon />
            </SearchContainer>
          </HeadingContainer>
